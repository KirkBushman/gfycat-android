...
class SharedPrefsStorageManager(context: Context) : StorageManager {
    ...
    companion object {
        ...
        private const val LAST_RESOURCE_OWNER = "android_gfycat_oauth2_current_owner"
        private const val LAST_REFRESH_TOKEN = "android_gfycat_oauth2_current_refresh_token"
        private const val LAST_REFRESH_EXPIRES_IN = "android_gfycat_oauth2_current_refresh_expires_in"
        private const val LAST_ACCESS_TOKEN = "android_gfycat_oauth2_current_access_token"
        private const val LAST_EXPIRES_IN = "android_gfycat_oauth2_current_expires_in"
